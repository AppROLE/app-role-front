          ...
          <PresenceContextProvider>
            <GestureHandlerRootView style={{ flex: 1 }}>
              <Stack>
                ...
                <Stack.Screen name="searching-filters/index" options={{ headerShown: false }} />
                <Stack.Screen name="(tabs)" options={{ headerShown: false }} />
                <Stack.Screen name="first-page/index" options={{ headerShown: false }} />
                <Stack.Screen name="editing-perfil/index" options={{ headerShown: false }} />
                <Stack.Screen name="configs/index" options={{ headerShown: false }} />
                <Stack.Screen name="configs/delete/index" options={{ headerShown: false }} />
                <Stack.Screen name="institution/index" options={{ headerShown: false }} />
                <Stack.Screen name="role-description/index" options={{ headerShown: false }} />
