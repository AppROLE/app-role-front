    ...
    return (
        <View className="bg-background w-full h-full flex-1">
            ...
            >
                ...
                />
                <TouchableOpacity className="w-12 h-12 bg-black/50 flex justify-center items-center rounded-full absolute top-20 left-8"
                    onPress={async () => {
                ...
                <View className="w-11/12 h-16 mx-auto bg-black/50 mt-auto rounded-full flex flex-row items-center justify-around p-2  mb-4">
